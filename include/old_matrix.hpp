...
class Undef_Operation : public std::runtime_error {};

class Undef_Sum : public Undef_Operation
{
    const char *what () const noexcept override
    {
        return "Sum of matrices of different size is not defined";
    }
};

class Undef_Diff : public Undef_Operation
{
    const char *what () const noexcept override
    {
        return "Difference of matrices of different size is not defined";
    }
};

class Undef_Product : public Undef_Operation
{
    const char *what () const noexcept override
    {
        return "Product of matrices of different size is not defined";
    }
};

class Undef_Det : public Undef_Operation
{
    const char *what () const noexcept override
    {
        return "Determinant is not defined for non-square matrices";
    }
};
